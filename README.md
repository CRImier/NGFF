# [NGFF](https://github.com/Qful/NGFF) 

[![sites](http://182.61.61.133/link/resources/Qful.png)](https://stop.stops.top) 

### [NGFF简介](https://github.com/Qful/NGFF)

[NGFF](https://github.com/Qful/NGFF) (Next Generation Form Factor)，与 NGFF 并列的是 2.5"（2.5”硬盘（包括HDD和SSD）厚度一般为9.5mm和7mm），NGFF现在已经改名为M.2，M.2有SATA 和PCIe两种总线标准。
